    ...
    <section id="projects" className="py-16 sm:py-24 px-4 sm:px-6 md:px-12 max-w-7xl mx-auto relative overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4 mb-8 sm:mb-10">
        ...
        <div className="flex items-center gap-3 w-full md:w-auto">
          ...
          <span className="text-xs font-mono text-zinc-300 font-medium whitespace-nowrap hidden lg:block">
            {language === 'kn'
              ? `${projects.length} ರಲ್ಲಿ ${filteredProjects.length}`
              : language === 'te'
              ? `${projects.length} లో ${filteredProjects.length}`
