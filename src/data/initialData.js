export const INITIAL_PROJECTS = [
  {
    ...
    tags: ["React", "Vite", "Tailwind CSS", "Interactive RSVP", "Audio Web"],
    featured: true,
    year: "2026",
  ...
  },
  {
    ...
    githubUrl: "https://github.com",
    tags: ["React", "CSS Animations", "Vite", "Editorial Layout"],
    featured: true,
    year: "2026",
  ...
  },
  {
    ...
    longDescription: "Crafted to deliver an unforgettable digital first impression. Features animated floral reveals, timeline countdown, venue location pinpoints, and instant social card previews optimized for WhatsApp and Instagram sharing.",
    imageUrl: "https://wedding-invite-tau-one.vercel.app/images/hero_bg.jpg",
    liveUrl: "https://m-invitation-demo1.vercel.app/",
    githubUrl: "https://github.com",
    tags: ["React", "Tailwind CSS", "Social Previews", "Countdown Engine"],
    featured: true,
    year: "2026",
...
export const INITIAL_STUDIO_PROFILE = {
  ...
  stats: [
    ...
    { label: "Interactive Deployments", value: "28+" },
    { label: "Client Satisfaction", value: "100%" },
    { label: "Uptime & Performance", value: "99.9%" }
  ],
  services: [
    {
